...
public class ReporteEvaluacionConsolidadoDao extends GenericDao<ReporteEvaluacionConsolidadoEt, Long> implements IReporteEvaluacionConsolidadoDao {

	public ReporteEvaluacionConsolidadoDao() {
		super(ReporteEvaluacionConsolidadoEt.class);
	}
	...
	public String generar(Date fechaDesde, Date fechaHasta, Long idZona, Long idEvaluacion, Long idNivelEvaluacion, Long idNivelEvaluacionD, Long idUsuario) {
		StoredProcedureQuery query = this.em.createNamedStoredProcedureQuery("getGenerarReporteConsolidado");
