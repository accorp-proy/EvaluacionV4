...
public class ReporteEvaluacionNivelRiesgoDao extends GenericDao<ReporteEvaluacionNivelRiesgoEt, Long> implements IReporteEvaluacionNivelRiesgoDao {

	public ReporteEvaluacionNivelRiesgoDao() {
		super(ReporteEvaluacionNivelRiesgoEt.class);
	}
	...
	public String generar(Date fechaDesde, Date fechaHasta, Long idZona, Long idEvaluacion, Long idNivelEvaluacion, Long idNivelEvaluacionD, Long idUsuario) {
		StoredProcedureQuery query = this.em.createNamedStoredProcedureQuery("getGenerarReporteNivelRiesgo");
