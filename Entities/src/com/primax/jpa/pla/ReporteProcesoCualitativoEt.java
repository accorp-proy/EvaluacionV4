...
@Entity
@Table(name = "REPORTE_PROCESO_CUALITATIVO_ET")
@Audited

@NamedStoredProcedureQuery(name = "getGenerarReporteProcesoCualitativo", procedureName = "fun_generar_rpt_proceso_cualitativo", resultClasses = ReporteProcesoCualitativoEt.class, parameters = {
...
public class ReporteProcesoCualitativoEt extends EntityBase implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "sec_reporte_proceso_cualitativo_et", sequenceName = "seq_reporte_proceso_cualitativo_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_reporte_proceso_cualitativo_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_reporte_proceso_cualitativo")
	private Long idReporteProcesoCualitativo;
	...
	@Column(name = "mes_01_s", length = 100)
	private String mes01S;

	@Column(name = "mes_02_s", length = 100)
	private String mes02S;

	@Column(name = "mes_03_s", length = 100)
	private String mes03S;

	@Column(name = "mes_04_s", length = 100)
	private String mes04S;

	@Column(name = "mes_05_s", length = 100)
	private String mes05S;

	@Column(name = "mes_06_s", length = 100)
	private String mes06S;

	@Column(name = "mes_07_s", length = 100)
	private String mes07S;

	@Column(name = "mes_08_s", length = 100)
	private String mes08S;

	@Column(name = "mes_09_s", length = 100)
	private String mes09S;

	@Column(name = "mes_10_s", length = 100)
	private String mes10S;

	@Column(name = "mes_11_s", length = 100)
	private String mes11S;

	@Column(name = "mes_12_s", length = 100)
	...
	public ReporteProcesoCualitativoEt() {
		this.condicion = 0L;
		this.idAgencia = 0L;
	...
	public Long getIdReporteProcesoCualitativo() {
		return idReporteProcesoCualitativo;
	}

	public void setIdReporteProcesoCualitativo(Long idReporteProcesoCualitativo) {
		this.idReporteProcesoCualitativo = idReporteProcesoCualitativo;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ReporteProcesoCualitativoEt) {

			ReporteProcesoCualitativoEt other = (ReporteProcesoCualitativoEt) obj;
			if (this.idReporteProcesoCualitativo == null)
				return this == other;

			return this.idReporteProcesoCualitativo.equals(other.idReporteProcesoCualitativo);
		}
		return false;
	}
