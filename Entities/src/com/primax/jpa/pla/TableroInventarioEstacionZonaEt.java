...
@Entity
@Table(name = "TABLERO_INVENTARIO_ESTACION_ZONA_ET")
public class TableroInventarioEstacionZonaEt extends EntityBase implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "sec_tablero_inventario_estacion_zona_et", sequenceName = "seq_tablero_inventario_estacion_zona_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_tablero_inventario_estacion_zona_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_tablero_inventario_estacion_zona")
	private Long idTableroInventarioEstacionZona;
	...
	public TableroInventarioEstacionZonaEt() {
		this.total = 0L;
		this.nivel01 = 0L;
		this.nivel02 = 0L;
		this.nivel03 = 0L;
	...
	public Long getIdTableroInventarioEstacionZona() {
		return idTableroInventarioEstacionZona;
	}

	public void setIdTableroInventarioEstacionZona(Long idTableroInventarioEstacionZona) {
		this.idTableroInventarioEstacionZona = idTableroInventarioEstacionZona;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof TableroInventarioEstacionZonaEt) {

			TableroInventarioEstacionZonaEt other = (TableroInventarioEstacionZonaEt) obj;
			if (this.idTableroInventarioEstacionZona == null)
				return this == other;

			return this.idTableroInventarioEstacionZona.equals(other.idTableroInventarioEstacionZona);
		}
		return false;
	}
