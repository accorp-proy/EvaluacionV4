...
@Entity
@Table(name = "TABLERO_EVALUACION_MES_ET")
public class TableroEvaluacionMesEt extends EntityBase implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "sec_tablero_evaluacion_mes_et", sequenceName = "seq_tablero_evaluacion_mes_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_tablero_evaluacion_mes_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_tablero_evaluacion_mes")
	private Long idTableroEvaluacionMes;
	...
	public Long getIdTableroEvaluacionMes() {
		return idTableroEvaluacionMes;
	}

	public void setIdTableroEvaluacionMes(Long idTableroEvaluacionMes) {
		this.idTableroEvaluacionMes = idTableroEvaluacionMes;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof TableroEvaluacionMesEt) {

			TableroEvaluacionMesEt other = (TableroEvaluacionMesEt) obj;
			if (this.idTableroEvaluacionMes == null)
				return this == other;

			return this.idTableroEvaluacionMes.equals(other.idTableroEvaluacionMes);
		}
		return false;
	}
