...
@Entity
@Table(name = "TABLERO_INVENTARIO_MES_ET")
public class TableroInventarioMesEt extends EntityBase implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "sec_tablero_inventario_mes_et", sequenceName = "seq_tablero_inventario_mes_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_tablero_inventario_mes_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_tablero_inventario_mes")
	private Long idTableroInventarioMes;
	...
	public Long getIdTableroInventarioMes() {
		return idTableroInventarioMes;
	}

	public void setIdTableroInventarioMes(Long idTableroInventarioMes) {
		this.idTableroInventarioMes = idTableroInventarioMes;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof TableroInventarioMesEt) {

			TableroInventarioMesEt other = (TableroInventarioMesEt) obj;
			if (this.idTableroInventarioMes == null)
				return this == other;

			return this.idTableroInventarioMes.equals(other.idTableroInventarioMes);
		}
		return false;
	}
