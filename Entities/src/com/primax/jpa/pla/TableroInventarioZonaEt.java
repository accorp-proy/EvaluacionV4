...
@Entity
@Table(name = "TABLERO_INVENTARIO_ZONA_ET")

@NamedStoredProcedureQuery(name = "getGenerarInventarioZona", procedureName = "fun_generar_tab_inventario_zona", resultClasses = TableroEstacionZonaEt.class, parameters = {
...
public class TableroInventarioZonaEt extends EntityBase implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "sec_tablero_inventario_zona_et", sequenceName = "seq_tablero_inventario_zona_et", allocationSize = 1, initialValue = 1)
	@GeneratedValue(generator = "sec_tablero_inventario_zona_et", strategy = GenerationType.SEQUENCE)
	@Column(name = "id_tablero_inventario_zona")
	private Long idTableroInventarioZona;
	...
	public TableroInventarioZonaEt() {
		this.total = 0L;
		this.nivel01 = 0L;
		this.nivel02 = 0L;
		this.nivel03 = 0L;
	...
	public Long getIdTableroInventarioZona() {
		return idTableroInventarioZona;
	}

	public void setIdTableroInventarioZona(Long idTableroInventarioZona) {
		this.idTableroInventarioZona = idTableroInventarioZona;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof TableroInventarioZonaEt) {

			TableroInventarioZonaEt other = (TableroInventarioZonaEt) obj;
			if (this.idTableroInventarioZona == null)
				return this == other;

			return this.idTableroInventarioZona.equals(other.idTableroInventarioZona);
		}
		return false;
	}
