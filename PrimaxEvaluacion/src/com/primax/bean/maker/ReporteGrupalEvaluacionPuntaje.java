...
public class ReporteGrupalEvaluacionPuntaje extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		try {
			...
			if (isexcel) {
				nombreReporte = "rptEvaluacionPuntajeExcel.jasper";
			} else {
				nombreReporte = "rptEvaluacionPuntajePdf.jasper";
			}
		} catch (Exception e) {
			e.printStackTrace();
