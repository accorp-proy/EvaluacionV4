...
public class ReporteGrupalTipoEvaluacionCons extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		try {
			...
			if (isexcel) {
				nombreReporte = "rptTipoEvaluacionConsolidadoExcel.jasper";
			} else {
				nombreReporte = "rptTipoEvaluacionConsolidadoPdf.jasper";
			}
		} catch (Exception e) {
			e.printStackTrace();
