...
public class ReportePlantillaCriterioGeneral extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		Long idCheckList = Long.valueOf(params.get("p2")[0]);
		...
		paramRpt.put("id_check_list", idCheckList);
		...
		try {
			...
			JasperPrint jprint = JasperFillManager.fillReport(
					localPath + File.separator + "plantilla" + File.separator + "rptPlantillaCriterioGeneral.jasper", paramRpt, cn);
