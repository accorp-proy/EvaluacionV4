...
public class ReporteGrupalPlanificacionInventario extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		try {
			...
			if (isexcel) {
				nombreReporte = "rptPlanificacionInventarioExcel.jasper";
			} else {
				nombreReporte = "rptPlanificacionInventarioPdf.jasper";
			}
		} catch (Exception e) {
			e.printStackTrace();
