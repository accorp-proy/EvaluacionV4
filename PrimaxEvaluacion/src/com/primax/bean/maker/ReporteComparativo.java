...
public class ReporteComparativo extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		paramRpt.put("par_id_comparativo", Long.valueOf(params.get("p1")[0]));
		paramRpt.put("SUBREPORT_DIR", localPath + File.separator + "cartera" + File.separator);
		Connection cn = null;
		try {
			cn = DataSourceConnection.getJNDIConnection();
			JasperPrint jprint = JasperFillManager.fillReport(
					localPath + File.separator + "cartera" + File.separator + "rptComparativo.jasper", paramRpt, cn);
