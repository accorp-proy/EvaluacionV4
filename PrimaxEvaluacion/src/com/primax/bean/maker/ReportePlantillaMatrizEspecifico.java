...
public class ReportePlantillaMatrizEspecifico extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		String nombreCheckList = params.get("p3")[0] == null ? "matriz" : params.get("p3")[0].toUpperCase();
		...
		try {
			...
			JasperPrint jprint = JasperFillManager.fillReport(
					localPath + File.separator + "plantilla" + File.separator + "rptPlantillaMatrizRiego.jasper", paramRpt, cn);
