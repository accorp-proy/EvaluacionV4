...
public class ReporteIndividualArqueoCajaFondoSuelto extends BaseReport {
	...
	public ByteArrayOutputStream getReport(Map<String, String[]> params, String localPath, ServletContext servlet,
		...
		try {
			...
			JasperPrint jprint = JasperFillManager.fillReport(
					localPath + File.separator + "ejecucion" + File.separator + "rptArqueoCajaFondoSuelto.jasper",
					paramRpt, cn);
