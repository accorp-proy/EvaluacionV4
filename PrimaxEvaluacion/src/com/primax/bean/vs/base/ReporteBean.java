...
public class ReporteBean extends BaseBean implements Serializable {
	...
	public void imprimirExcel(Long idRep, String p1, String p2, String p3, String p4, String p5, String p6, String p7, String p8, String p9, String p10, boolean condicion) {
		...
		case "1":
			...
			try {
				if (p5.endsWith("2")) {
					...
					exportIt(reportePlantillaCriterioEspecifico.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "CheckList" + "_" + p3 + "_" + p4);
				} else {
					ReportePlantillaCriterioGeneral reportePlantillaCriterioGeneral = new ReportePlantillaCriterioGeneral();
					exportIt(reportePlantillaCriterioGeneral.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "CheckList" + "_" + p3 + "_" + p4);
				}
		...
		case "2":
			...
			try {
				exportIt(reportePlantillaMatrizEspecifico.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Matriz" + "_" + p2 + "_" + p3);
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "3":
			...
			try {
				exportIt(reporteProcesoDetalle.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "ReporteDetalleKPIs");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		...
		case "4":
			...
			try {
				exportIt(reporteIndividualArqueoCajaPT.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "ArqueoVisitaControl_Interno" + "_" + p4);
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		...
		case "5":
			...
			try {
				exportIt(reporteIndividualArqueoCajaFondoSuelto.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "ArqueoDisponibilidadFondoSuelto");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "6":
			...
			try {
				exportIt(reporteIndividualCheckListEjecutado.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "CheckList" + "_" + p4 + "_" + p3);
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "7":
			...
			try {
				exportIt(reporteIndividualCheckListEjecutadoEspecifico.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "CheckList" + "_" + p4 + "_" + p3);
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "8":
			...
			try {
				exportIt(reporteIndividualMatrizEjecutado.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "MatrizRiesgo" + "_" + p4 + "_" + p3);
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "9":
			...
			try {
				exportIt(reporteIndividualArqueoCajaChicaGeneral.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "ArqueoCajaChicaEstaciónServicio");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "10":
			...
			try {
				exportIt(reporteIndividualArqueoConsolidado.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "ArqueoConsolidado");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "11":
			...
			try {
				exportWord(reporteIndividualNovedadControl.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte de Novedades");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "12":
			...
			try {
				exportIt(reporteGrupalEvaluacionPuntaje.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Evaluacion_Puntaje_Estacion");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "13":
			...
			try {
				exportIt(reporteGrupalEvaluacionNivelRiesgo.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Evaluacion_Nivel_Riesgo");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "14":
			...
			try {
				exportIt(reporteGrupalEvaluacionConsolidado.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Consolidado_Nivel_Riesgo");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "15":
			...
			try {
				exportIt(reporteIndividualPlanAccionGeneral.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Plan_Acción");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "16":
			...
			try {
				exportIt(reporteIndividualPlanAccionEspecifico.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Plan_Acción");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		...
		case "17":
			...
			try {
				exportIt(reporteGrupalTipoEvaluacion.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Tipo_Evaluación");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		...
		case "18":
			...
			try {
				exportIt(reporteGrupalEvaluacionPlanificacion.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Panificacion_Cumplimiento");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "19":
			...
			try {
				exportIt(reporteGrupalEvaluacionVariacion.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Variación_Visitas");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "20":
			...
			try {
				exportIt(reporteIndividualPlanAccionSeguimientoEspecifico.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Plan_Acción");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "21":
			...
			try {
				exportWord(reporteIndividualNovedadCCTV.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte de Novedades CTTV");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		...
		case "22":
			...
			try {
				exportIt(reporteGrupalEvaluacionPuntaje0.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Evaluacion_Puntaje_Estacion");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		...
		case "23":
			...
			try {
				exportIt(reporteGrupalConsolidadoProceso.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Consolidado_Proceso_Estacion");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "24":
			...
			try {
				exportIt(reporteGrupalTableroControl.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Tablero_Control");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "26":
			...
			try {
				exportIt(reporteGrupalPlanificacionInventario.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Planificacion_Inventario");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "27":
			...
			try {
				exportIt(reporteGrupalTipoEvaluacionCons.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Evaluacion_Consolidado");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "28":
			...
			try {
				exportIt(reporteGrupalTipoInventario.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Tipo_Iventario");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
		case "29":
			...
			try {
				exportIt(rptIndividualPlanAccionInv.getReport(params, WebAppUtil.getServletContext().getRealPath(reportPath), WebAppUtil.getServletContext(), excel), "Reporte_Plan_Acción");
			} catch (NumberFormatException | EntidadNoEncontradaException e) {
				e.printStackTrace();
			}
			break;
